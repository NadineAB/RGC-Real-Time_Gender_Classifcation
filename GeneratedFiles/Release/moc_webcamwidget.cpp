...
**
** Created: Wed 28. Aug 16:25:55 2013
...
void gui::WebcamWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData gui::WebcamWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject gui::WebcamWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_gui__WebcamWidget,
      qt_meta_data_gui__WebcamWidget, &staticMetaObjectExtraData }
};
