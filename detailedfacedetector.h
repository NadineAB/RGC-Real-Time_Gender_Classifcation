...
namespace cognition
{
	...
	public:
		...
		enum DetectParams 
		{
			FACE = 0,
			PFACE = 1,
               LEFT_EYE = 2,  /* leftmost eye, when loading the cascade, only load EYES!*/
			RIGHT_EYE = 3, /* rightmost eye, when loading the cascade, only load EYES!*/
			EYES = 4,
			NOSE = 5,
			EYES_AND_NOSE = 9,
			MOUTH = 10,
		 ...
		 */
		// change the  optimalSubregionDetect to ture NADINE 
	...
	protected:
		...
		cv::CascadeClassifier profileClassifier;
