...
namespace cognition
{
	...
	public:
		 ...
		 *
		 * \param goalSize			the size to which images are to be scaled which basically should be 180X200
		 ...
		 */
		TrainerImage(cv::Size goalSize = cv::Size(180,200), bool keepAspectRatio = true, const std::string& directoryPath = "")
		 ...
		 */
		bool processAndSaveImage(cv::Mat& image,  const std::string& name, std::string dirPath);
